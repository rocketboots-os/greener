<cfscript>
	...
	if (not structKeyExists(url, "step")) {
		...
		helloWorld = helper.greenify("HelloTailWorld");			// compile and return instance of "greener" component
		...
		session.greenThread = {
			...
			stack = [{
				...
				localVars = {n = 3, arguments = {n = 3}},	// local variables including arguments
